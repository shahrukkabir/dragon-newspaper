            ...
            <div className="bg-gray-800 p-10 rounded-2xl shadow-xl w-[28rem] border border-gray-600">
                ...
                <form onSubmit={handleSubmit}>
                    <div className="mb-6">
                        ...
                        <input name="email" type="email" placeholder="Enter your email" className="w-full px-4 py-3 border border-gray-500 bg-gray-700 text-gray-200 rounded-lg focus:ring focus:ring-blue-500 focus:border-blue-500 outline-none" />
                    </div>
                    <div className="mb-6">
                        <label className="block text-sm font-medium text-gray-300 mb-2">Password</label>
                        <input name="password" type="password" placeholder="Enter your password" className="w-full px-4 py-3 border border-gray-500 bg-gray-700 text-gray-200 rounded-lg focus:ring focus:ring-blue-500 focus:border-blue-500 outline-none" />
                    </div>
